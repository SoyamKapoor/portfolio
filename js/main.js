    ...
    options: {
      ...
      scales: {
        r: {
          ...
          grid:        { color: 'rgba(255,255,255,.06)' },
          angleLines:  { color: 'rgba(255,255,255,.06)' },
          pointLabels: { color: 'rgba(144,144,168,.8)', font: { family: 'JetBrains Mono', size: 12 } },
        },
      },
    },
  });
...
const MODAL_DATA = [
  {
    num:   '// 01',
    title: 'Project Name Here',
    desc:  'This is where you write a longer, more detailed description of the project.',
    stack: [
      { label: 'Python',           cls: 'tc' },
      { label: 'Machine Learning', cls: 'tv' },
      { label: 'Pandas',           cls: 'tw2' },
  ...
  },
  {
    num:   '// 02',
    title: 'Project Name Here',
    desc:  'Detailed description of project 2.',
    stack: [{ label: 'Python', cls: 'tc' }, { label: 'TensorFlow', cls: 'tv' }, { label: 'NumPy', cls: 'tw2' }],
    github: 'YOUR_GITHUB_REPO',
    demo:   '',
  },
  {
    num:   '// 03',
    title: 'Project Name Here',
    desc:  'Detailed description of project 3.',
    stack: [{ label: 'Python', cls: 'tc' }, { label: 'SQL', cls: 'to' }, { label: 'Matplotlib', cls: 'tw2' }],
    github: 'YOUR_GITHUB_REPO',
    demo:   '',
  },
